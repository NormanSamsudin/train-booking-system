                    ...
                    itemBuilder: (context, index) {
                      ...
                      switch (seat[index].status) {
                        case 'available':
                          ...
                          break;
                        case 'locked':
                          seatColor = Colors.grey; // Locked seats are grey
                          break;
                        default:
                          seatColor = Colors.red; // Unavailable seats are red
                      }
                          ...
                          onTap: () {
                            if (seat[index].status == 'available') {
                              ...
                              setState(() {
                                ...
                                selectedSeats
                                    .add(seat[index]); // Add to selected seats
                              });
                              ...
                              showSnackBar(
                                  context, 'Seat have been locked by others');
                            } else {
                              debugPrint("seat is not available");
                              Navigator.of(context).pop();
                              showSnackBar(
                                  context, 'Seat have been booked by others');
                            }
                          },
                        ),
                      );
